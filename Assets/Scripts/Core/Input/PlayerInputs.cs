...
namespace StarterAssets
{
    public class PlayerInputs : MonoBehaviour
    {
        ...
        /// <summary>
        /// Stone carving input values
        /// </summary>
        [Header("Stone Carving Input Values")]
        public bool carve;          // Is the carve button pressed?
        public Vector2 moveBrush;   // Gamepad stick movement
        public bool exitCarving;    // Exit button
        public bool undo;
        ...
        // Input System automatically looks for "On" + "Action Name" methods
