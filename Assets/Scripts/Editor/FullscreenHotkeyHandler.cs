...
{
    bool makeFullscreenAtStart = false; // Set to true if you want auto-fullscreen on play
    ...
    void Update()
    {
        // Toggle fullscreen when comma key pressed during gameplay
...
public static class FullscreenGameView
{
    ...
    [MenuItem("Window/General/Game (Fullscreen) ,", priority = 2)]
