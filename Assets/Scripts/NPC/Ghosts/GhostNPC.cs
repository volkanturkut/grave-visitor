...
public class GhostNPC : MonoBehaviour, IInteractable
{
    ...
    private void StartTalking()
    {
        ...
        if (!_hasTalkedOnce)
        {
            ...
            {
                DebugLogger.LogWarning("GhostNPC: 'Normal Dialogue' is not assigned in the Inspector!");
                ResumeWandering();
            }
        }
        else
        {
            ...
            if (missionEndDialogue != null)
            {
                ...
                DialogueManager.Instance.StartDialogue(missionEndDialogue, this, () =>
                {
                    ...
                    {
                        DebugLogger.LogError("GhostNPC: You forgot to attach the 'GhostAscension' script!");
            ...
            {
                DebugLogger.LogWarning("GhostNPC: 'Mission End Dialogue' is not assigned in the Inspector!");
                ResumeWandering();
            }
        }
    }
